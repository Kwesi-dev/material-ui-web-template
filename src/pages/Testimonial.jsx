        ...
        <Container maxWidth="lg">
            <Grid container sx={{width: "100%"}}>
                <Grid item xs={12} md={6} sx={{width: "100%", display: {xs: "flex", md: "block"}, flexDirection: "column", alignContent: "center", justifyContent: "center", mb: {xs: 10, md: 0}}}>
                    ...
                    <Typography variant="h4" sx={{width: "60%", fontWeight: "bold", mb: 2, textAlign: {xs: "center", md: "inherit"}, alignSelf: {xs:"center", md: "inherit"}}} color="#202140">
                        Join More Than 90,000+ Amazing
                        People Loves Our Product
                    </Typography>
                    <Typography variant="body1" sx={{width: "65%", fontWeight: "light", mb: 2, textAlign: {xs: "center", md: "inherit"}, alignSelf: {xs:"center", md: "inherit"}}} color="#202140">
